...
summary: Debe crear un rol de clúster de ONTAP con privilegios mínimos para no tener que usar el rol de administrador de ONTAP para realizar operaciones en SnapCenter. 
---
