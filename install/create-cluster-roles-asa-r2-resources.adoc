...
summary: Debe crear roles de clúster de ONTAP para sistemas ASA r2 de modo que no tenga que usar el rol de administrador de ONTAP para realizar operaciones en SnapCenter. 
---
