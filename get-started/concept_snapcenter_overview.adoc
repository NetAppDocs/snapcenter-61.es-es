...
** Datos que se encuentran en sistemas primarios y secundarios de ONTAP FAS, AFF o ASA y están protegidos en almacenamiento de objetos y archivos en la nube (mediante la integración de BlueXP backup and recovery )
