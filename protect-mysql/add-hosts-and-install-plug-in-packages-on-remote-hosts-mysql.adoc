...
NOTE: El complemento para MySQL debe instalarse en el servidor de base de datos MySQL.
...
+
Al utilizar la API REST para instalar el complemento para MySQL, debe pasar la versión como 3.0.  Por ejemplo, MySQL:3.0
...
Ruta de instalación
 a| 
El complemento para MySQL se instala en el host del cliente MySQL, y este host puede estar en un sistema Windows o en un sistema Linux.
...
.Después de terminar
Si desea actualizar a la versión 6.0 de SnapCenter , el complemento basado en PERL existente para MySQL se desinstalará del servidor de complementos remoto.
