...
sidebar: sidebar 
keywords: SnapCenter 
summary: Configurar el certificado CA para el servicio de complementos MySQL de SnapCenter en el host de Windows 
---
= Configurar el certificado CA para el servicio de complementos MySQL de SnapCenter en el host de Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
