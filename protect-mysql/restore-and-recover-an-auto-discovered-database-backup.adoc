...
* No se admite la recuperación automática en puntos específicos ni en momentos concretos.
...
. En la página Restaurar ámbito, seleccione *Recurso completo* para restaurar los volúmenes de datos configurados de la base de datos MySQL.
