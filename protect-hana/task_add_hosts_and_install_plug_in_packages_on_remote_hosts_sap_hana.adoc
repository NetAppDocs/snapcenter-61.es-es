...
+
link:../protect-hana/task_configure_gMSA_on_windows_server_2012_or_later.html["Configurar la cuenta de servicio administrada de grupo en Windows Server 2016 o posterior para SAP HANA"^]



.Acerca de esta tarea
* No es posible agregar un servidor SnapCenter como host de complemento a otro servidor SnapCenter .
* Para que la replicación del sistema SAP HANA descubra recursos en los sistemas primario y secundario, se recomienda agregar ambos sistemas mediante el usuario root o sudo.
...
NOTE: El complemento para SAP HANA se instala en el host del cliente HDBSQL, y este host puede estar en un sistema Windows o en un sistema Linux.
...
Debe configurar el cliente HDBSQL y HDBUserStore en este host.
...
Ruta de instalación
 a| 
El complemento para SAP HANA se instala en el host del cliente HDBSQL, y este host puede estar en un sistema Windows o en un sistema Linux.
