...
sidebar: sidebar 
keywords: SnapCenter 
summary: Configurar el certificado de CA para el servicio de complementos SAP HANA de SnapCenter en el host de Windows 
---
= Configurar el certificado de CA para el servicio de complementos SAP HANA de SnapCenter en el host de Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
