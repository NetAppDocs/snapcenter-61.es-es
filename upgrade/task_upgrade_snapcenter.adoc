...
summary: Puede utilizar el archivo ejecutable del instalador de SnapCenter Server para actualizar SnapCenter Server. 
---
= Actualizar el servidor SnapCenter en el host de Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Para obtener más información, consultelink:../admin/concept_manage_the_snapcenter_server_repository.html#back-up-the-snapcenter-repository["Realice una copia de seguridad del repositorio de SnapCenter"^] .
...
.Pasos
. Descargue el paquete de instalación de SnapCenter Server desde el sitio de soporte de NetApp .
+
https://mysupport.netapp.com/site/products/all/details/snapcenter/downloads-tab[]

. Cree una copia del archivo web.config ubicado en C:\Archivos de programa\ NetApp\ SnapCenter WebApp.
...
. Cree el volcado de base de datos MySQL de SnapCenter si la copia de seguridad del repositorio no está configurada.
+
...
.Después de terminar
* Si el complemento se instala mediante un usuario sudo, debe copiar las claves sha224 disponibles en _C:\ProgramData\ NetApp\ SnapCenter\Package Repository\sc_unix_plugins_checksum.txt_ para actualizar el archivo _/etc/sudoers_.
* Deberías realizar un nuevo descubrimiento de recursos en el host del servidor.
+
...
* Después de actualizar el host del servidor, también debe actualizar los complementos antes de agregar cualquier sistema de almacenamiento.
