...
summary: 'La frecuencia de copia de seguridad (tipo de programación) se especifica en las políticas; una programación de copia de seguridad se especifica en la configuración del grupo de recursos.' 
---
= Programaciones de copias de seguridad para el complemento para SQL Server
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
