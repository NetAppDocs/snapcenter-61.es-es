...
summary: 'Debe crear una conexión de máquina virtual de almacenamiento (SVM) y una credencial antes de usar los cmdlets de PowerShell para realizar copias de seguridad, restaurar o clonar clústeres de PostgreSQL.' 
---
= Cree una conexión al sistema de almacenamiento y una credencial mediante cmdlets de PowerShell para PostgreSQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debe crear una conexión de máquina virtual de almacenamiento (SVM) y una credencial antes de usar los cmdlets de PowerShell para realizar copias de seguridad, restaurar o clonar clústeres de PostgreSQL.
...
----
. Instale el paquete y el complemento SnapCenter para PostgreSQL en el host.
+
Para Linux:
...
+
Para Windows, el complemento PostgreSQL utilizará la ruta predeterminada para la carpeta SQLLIB: “C:\Program Files\IBM\SQLLIB\BIN”
