...
* Para la operación de copia de seguridad basada en instantáneas, asegúrese de que todos los clústeres de inquilinos sean válidos y activos.
...
+
Este ejemplo muestra cómo agregar una instancia de PostgreSQL:
