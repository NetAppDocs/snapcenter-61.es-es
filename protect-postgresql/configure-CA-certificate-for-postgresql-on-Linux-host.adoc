...
sidebar: sidebar 
keywords: SnapCenter 
summary: Configurar el certificado CA para el servicio de complementos PostgreSQL de SnapCenter en el host Linux 
---
= Configurar el certificado CA para el servicio de complementos PostgreSQL de SnapCenter en el host Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
