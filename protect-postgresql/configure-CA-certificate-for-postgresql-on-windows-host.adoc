...
sidebar: sidebar 
keywords: SnapCenter 
summary: Configurar el certificado de CA para el servicio de complementos de SnapCenter PostgreSQL en el host de Windows 
---
= Configurar el certificado de CA para el servicio de complementos de SnapCenter PostgreSQL en el host de Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
